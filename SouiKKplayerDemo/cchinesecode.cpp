...
void CChineseCode::wcharTochar(const wchar_t *wchar, char *chr, int length)  
{  
	WideCharToMultiByte( CP_ACP, 0, wchar, -1,  
		chr, length, NULL, NULL );  
} 
void  CChineseCode::WcharUniToUTF_8(const wchar_t *wchar, char *chr, int length)  
{
	WideCharToMultiByte( CP_UTF8, 0, wchar, -1, chr, length, NULL, NULL );
}

void CChineseCode::charTowchar(const char *chr, wchar_t *wchar, int size)  
{     
...
std::string  CChineseCode::GBKToUTF8(const std::string& strGBK)  
{  
	string strOutUTF8 = "";  
	WCHAR * str1;  
